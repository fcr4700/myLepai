...
import qf.com.myprojectlepai.adapter.ZixunViewPagerAdapter;
import qf.com.myprojectlepai.fragment.zixunFragment.JxFragment;
import qf.com.myprojectlepai.fragment.zixunFragment.QiCaiFragment;

/**
 * Created by lenovo on 2016/9/2.
 */
public class ZiXunFragment extends Fragment {
    ZixunViewPagerAdapter adapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ZixunViewPagerAdapter(getActivity().getSupportFragmentManager(), fragmentList);
    ...
    private void initData() {
        ...
        fragmentList.add(new JxFragment().newInstance("JINGXUAN"));
        fragmentList.add(new QiCaiFragment().getInstance("QICAI"));
        fragmentList.add(new QiCaiFragment().getInstance("YINGXIANG"));
        fragmentList.add(new QiCaiFragment().getInstance("XUEYUAN"));
    }
