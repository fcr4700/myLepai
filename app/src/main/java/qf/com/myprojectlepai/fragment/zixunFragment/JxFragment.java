...
import qf.com.myprojectlepai.adapter.ZixunAdapter;
import qf.com.myprojectlepai.utils.HandlerJson;
...
//    ViewPager viewPager;
//    ZixunViewPagerAdapter viewPagerAdapter;
...
//    View headView;
    ...
    Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            adapter=new ZixunAdapter(dataListF,dataGridF,getActivity());
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments()!=null && getArguments().getString("name").equals("JINGXUAN")) {
